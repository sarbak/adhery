  ...
  const steps = [
    {
      ...
      note: 'Onboarding text sent automatically',
    },
    {
      day: 'Day 3',
      channel: 'SMS',
      ...
      note: 'Side effect caught. Reassurance sent instantly.',
    },
    {
      day: 'Day 5',
      channel: 'Voice',
      ...
      note: 'Escalated to voice because SMS flagged concern',
    },
    {
      day: 'Day 14',
      channel: 'SMS',
      ...
      note: 'Refill reminder - no action needed from your team',
    },
    {
      day: 'Day 30',
      channel: 'SMS',
      ...
      note: 'Milestone celebration. Maria replies "No, feeling good!"',
    },
  ];
